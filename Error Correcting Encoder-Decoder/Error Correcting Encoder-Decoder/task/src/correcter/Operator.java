...
import static correcter.Converter.getWithSpaces;
import static correcter.Converter.convertToHex;

public abstract class Operator {

    static void encode(String filename) {
        try (OutputStream writer = new FileOutputStream("encoded.txt")) {
            String text = new String(Files.readAllBytes(Paths.get(filename)));
            String hex = convertToHex(text, -1, 1);
            String bin = Converter.convertToBin(text, 8);
            ...
            System.out.println('\n' + filename + ":\n"
                    ...
                    + "hex view: " + getWithSpaces(convertToHex(encryption, 2, 8).toUpperCase(), 2));
